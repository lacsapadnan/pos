                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                <div class="mb-4">
                                    ...
                                    <select name="from_warehouse" class="form-select form-select-solid" data-control="select2"
                                        id="fromWarehouseSelect" data-dropdown-parent="#kt_modal_1">
                                        @if($roles === 'admin')
                                        ...
                                        @endforeach
                                        @else
                                        <option value="{{ auth()->user()->warehouse_id }}">{{ auth()->user()->warehouse->name }}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                <div class="mb-4">
                                    ...
                                    <select name="to_warehouse" class="form-select form-select-solid" data-control="select2"
                                        id="toWarehouseSelect" data-dropdown-parent="#kt_modal_1">
                                        <option disabled selected>Pilih Cabang</option>
                                        @foreach ($warehouses as $warehouse)
                                        <option value="{{ $warehouse->id }}">{{ $warehouse->name }}</option>
                                        @endforeach
