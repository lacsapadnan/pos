...
@includeIf('pages.supplier.modal')
@includeIf('pages.supplier.import')
@endsection
...
<script>
    "use strict";
        ...
        var KTDatatablesExample = function() {
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, row) {
                                return `
                                    @can('update supplier')
                                        <a href="{{ route('supplier.index') }}/${data}/edit" type="button" class="btn btn-warning btn-sm">
                                            <i class="ki-solid ki-pencil"></i>
                                            Edit
                                        </a>
                                    @endcan
                                    @can('hapus supplier')
                                        <form action="{{ route('supplier.index') }}/${data}" method="POST" class="d-inline">
                                            @csrf
                                            @method('delete')
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Supplier Data Report';
