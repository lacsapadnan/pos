...
@section('content')
            ...
            <div class="card-title">
                ...
                <div class="my-1 d-flex align-items-center position-relative">
                    <i class="ki-duotone ki-magnifier fs-1 position-absolute ms-4"><span class="path1"></span><span
                        ...
                        class="form-control form-control-solid w-250px ps-14" placeholder="Cari data permission">
                </div>
                <!--end::Search-->
            </div>
    ...
    @includeIf('pages.permission.modal')
@endsection
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                var routeUrl = "{{ route('permission.destroy', ':id') }}";
                                routeUrl = routeUrl.replace(':id', data);
                                return `
                                    <form action="${routeUrl}" method="POST" class="d-inline">
                                        @csrf
                                        @method('delete')
