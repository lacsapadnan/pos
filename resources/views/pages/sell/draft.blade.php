                ...
                datatable = $(table).DataTable({
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, row) {
                                return `
                                <a href="/penjualan-draft/${data}" class="btn btn-sm btn-primary">Lanjutkan Transaksi</a>
                                <form action="/penjualan-draft/${data}" method="POST" class="d-inline">
                                    @method('delete')
                                    @csrf
