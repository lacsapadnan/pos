...
@section('content')
    ...
    <div class="mt-5 border-0 card card-p-0 card-flush">
        <div class="mt-3">
            <form id="form1">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label for="inputEmail3" class="col-form-label">Invoice</label>
                            <input id="order_number" type="text" name="order_number" class="form-control"
                                value="{{ $credit->order_number }}" readonly />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input id="invoice" type="text" name="invoice" class="form-control"
                                placeholder="Masukan nomor faktur" value="{{ $credit->customer->name }}" readonly />
                        </div>
                    </div>
                </div>
            </form>
                ...
                <div class="table-responsive">
                    <table class="table align-middle border rounded table-row-dashed fs-6 g-5 dataTable no-footer"
                        ...
                        <tbody class="text-gray-900 fw-semibold">
                            @forelse ($sellReturs as $sellRetur)
                                @foreach ($sellRetur->detail ?? [] as $details)
                                    <tr>
                                        <td>
        ...
        <div class="mt-4 row">
            <div class="col-md-12">
                <form action="{{ route('bayar-piutang') }}" method="post">
                    @csrf
                    <div class="mb-3">
                        ...
                        <input id="total_hutang" type="text" name="total_hutang" class="form-control"
                            value="{{ number_format($credit->grand_total - $credit->pay) }}" readonly />
                    </div>
                    <div class="mb-3">
...
@push('addon-script')
    ...
    <script>
        ...
        $(document).ready(function() {
            let totalHutang = parseFloat('{{ $credit->grand_total - $credit->pay }}'.replace(/,/g, ''));
